...
INSERT INTO library_user (username, password, role, library_member_id) SELECT 'Member2', '$2a$10$upcOrDkFKHZgJtiPtLsfkuHsIUUX9vm7a6gRvrnpBjdim1.AL9Twe', 'MEMBER', 4 WHERE NOT EXISTS(SELECT 1 FROM library_user WHERE library_member_id = 4);